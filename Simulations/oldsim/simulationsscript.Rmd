...
c=chat_sim(n=10000,d=40,betasd=1,esd=0.1,K=10)
...
```{r}
system('/Users/sarahurbut/miniconda3/bin/sfa -gen strongprojectedtsimulations.txt -g 998 -k 5 -n 40 i -o simulationsL')
#system('sfa -gen strongprojectedtsimulations.txt -g 998 -k 5 -n 40 i -o simulationsL')
A="simulationsL"
...
#sign.test.ash=as.matrix(b$beta)$ash.pm
