...
knitr::opts_chunk$set(fig.width=12, fig.height=8, fig.path='~/Dropbox/PhDThesis/Figures/', warning=FALSE, message=FALSE)
```
...
mash.means=as.matrix(read.table("mashtruthwithfixedomegaposterior.means.txt"))
w=data.frame(wfull)
R=ncol(w)
j=10
