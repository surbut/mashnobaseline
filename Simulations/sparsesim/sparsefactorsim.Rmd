...
rm(list=ls())
library('mash')
source("~/matrix_ash/R/simulationswithmean.R")
set.seed(1)
RNGkind("Mersenne-Twister")
c=chat_sim_fsimple(n=10000,d=8,betasd=1,esd=0.1,K=3)


par(mfrow=c(2,3))
apply(c$factors,1,function(x){barplot(x)})
lapply(c$covmat,function(x){barplot(rowSums(x)!=0)})
...
```{r}
system('/Users/sarahurbut/miniconda3/bin/sfa -gen sparsestrongt.txt -g 506 -k 5 -n 8 i -o sparseF')
A="sparseF"
