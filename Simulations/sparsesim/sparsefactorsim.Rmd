...
```{r,eval=F,echo=F}
cov=readRDS("../sparsesim/covmattest.rds")
mash.means=as.matrix(read.table("../sparsesim/mashtruthposterior.means.txt")[,-1])
w=data.frame(wfull)
R=ncol(w)
j=10
...
mashnobase.means=as.matrix(read.table("../sparsesim/sparseLwithtruthposterior.means.txt")[,-1])
