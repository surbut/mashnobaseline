...
#plot(rowSums(absmat))
#points(index2,rowSums(absmat)[index2],col="blue")
...
plot(mash.fp,mash.power,cex=0.5,pch=1,xlim=c(0,0.2),lwd=1,ylim=c(0,0.4),col="green",ylab="True Positive Rate",xlab="False Positive Rate",type="l",main="")
