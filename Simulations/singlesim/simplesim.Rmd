...
par(mfrow=c(1,2))
barplot(colSums(matrix(pied[-length(pied)],ncol=11,byrow=TRUE)),names=c("ID",rep(paste0("Comp",seq(1:10)))),las=2,main="Mashnobase")
barplot(colSums(matrix(pimash[-length(pied)],ncol=11,byrow=TRUE)),names=c("ID",rep(paste0("Comp",seq(1:10)))),las=2,main="Mash")
```
