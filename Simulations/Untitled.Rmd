...
```{r}
set.seed(123)
c=chat_sim(n = 10000,d = 10,betasd = 1,esd = 1,K = 10)
...
```{r}
system('/Users/sarahurbut/miniconda3/bin/sfa -gen strongprojectedtsimulations.txt -g 995 -k 5 -n 10 i -o simulationsL')
A="simulationsL"
