...
eighteenguys=which(anno_ordered$time==18)
...
write.table(beta,"betafit18.txt",col.names = T)
write.table(se,"sefit18.txt",col.names = T)
write.table(t,"tfit18.txt",col.names = T)
...
b=read.table("betafit18.txt")
se=read.table("sefit18.txt")
...
write.table(t[index,],"maxttime18.txt",col.names = F ,row.names = F)
write.table(lf.ash,"lfash18.txt")

system('/Users/sarahurbut/miniconda3/bin/sfa -gen maxttime18.txt -g 10325 -k 5 -n 9 i -o johntimepoint18')

A="johntimepoint18"

factor.mat=as.matrix(read.table("johntimepoint18_F.out"))
lambda.mat=as.matrix(read.table("johntimepoint18_lambda.out"))
