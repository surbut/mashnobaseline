...
for(k in c(1:8)){
  ...
  tables1=read.table("~/Dropbox/oldnobaseline/john/s1table.txt",header = T,stringsAsFactors = F)[,-c(1,2)]
  ##ask why not the same as 
  l=lmFit(object = tables1[,knownsamples],model_mat_temp[,k],weights=vsarah$weights)
