...
---
In this document, we can use the mash estimates to estimate the posterior distribution of v using mash on the mean centered noisy estimates. Then, I use these posterior means added back to old mu to reestimate v.
